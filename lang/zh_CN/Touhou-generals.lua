return
{
	...
	["sumi_sakura"] = "完全墨染之樱",
	["sumisakura"] = "完全墨染之樱",
	["realsumisakura"] = "完全墨染之樱",
	[":sumi_sakura"] = "你受到伤害时，可选择将一点体力上限转换为灵力上限。（你的体力上限不能小于1）。之后你将灵力回复至灵力上限。",
	[":sumisakura"] = "回合开始时，若你灵力未达上限，你可指定一名玩家并选择下列中的一项执行：\
	1、回复X点灵力，弃X张手牌；\
	2、失去X点灵力，摸X张手牌；\
	其中X是你已损失的灵力值。",
	["alllost"] = "悉皆彷徨",
	...
	["nightlesscity"] = "红色不夜城",
	[":nightless_city"] = "回合外你的牌被弃置时，你可支付一点灵力，令当前回合的玩家进行判定：若为红色，你对其造成一点伤害并回复1点灵力。",
	...
	["fourninefive"] = "495年的波纹",
	[":four_nine_five"] = "每当你打出、使用的牌或翻开的战斗牌点数为4，9或5时，你回复一点体力。",
	["dare_mo_inai"] = "接下来谁都不剩了喔？",
	["daremoinai"]   = "接下来谁都不剩了喔？",
	[":dare_mo_inai"] = "出牌阶段，你可支付所有X点灵力（至少2点）并弃掉1张红桃手牌，令你攻击范围内的一名玩家进行X次判定：你对其造成X点伤害，但每有一种非红桃判定花色该伤害-1。",
	
	["pachuli"] = "帕秋莉 诺蕾姬",
	["philosopher_stone"] = "贤者之石",
	[":philosopher_stone"] = "你可以将任意张花色互不相同的牌，按以下规则使用：\
	1张：当做“事件解决”使用\
	2张：出牌阶段，回复一点体力\
	3张：出牌阶段，你在此回合后进行最多一个额外回合\
	4张：出牌阶段，你支付四点灵力，束缚一名其他玩家，直至游戏结束：对方回合开始时，你可以执行【观星4】。",
	["#PSExtraTurn"] = "%from 开始了一个额外回合",
	["philosopher_stone_constraint"] = "束缚：贤者之石",
	[":philosopher_stone_constraint"] = "你的回合开始时，帕秋莉可以执行【观星4】",
	["philosopherstone"] = "贤者之石",
	
	["youmu"] = "魂魄 妖梦",
	["double_sword_master"] = "未来永劫斩",
	[":double_sword_master"] = "进攻中你的战斗牌被克制时，可支付一点灵力将一张基本牌牌当作【春雪异变】对对方使用。进攻中你的战斗牌未被克制时，你回复一点灵力。",
	["snow-basic"] = "你可打出一张基本牌当作【春雪异变】对对方使用",
	
	["eirin"] = "八意 永琳",
	["arcanum"] = "蓬莱的秘药",
	[":arcanum"] = "你可将任意两张同花色手牌当作【蓬莱之药】使用。",
	["sharpmind"] = "思兼之脑",
	[":sharpmind"] = "你进攻攻击范围外的角色时，不需消耗灵力",
	["worldjar"] = "壶中天地",
	[":worldjar"] = "出牌阶段，你可支付2点灵力束缚X名玩家直到其回合结束，X为存活玩家数的一半（向下取整）：对方视为处于结界内侧，与其他不处于结界内侧的玩家互相不能指定为任何游戏牌的目标。",
	
	["#worldjar"] = "壶中天地" ,
	
	["worldjar_constraint"] = "束缚：壶中天地",
	[":worldjar_constraint"] = "你处于结界内，与结界外的玩家互相不能为任何游戏牌的目标",
	
	["kaguya"] = "蓬莱山 辉夜",
	["fiveproblem"] = "五道难题",
	[":fiveproblem"] = "你可以支付一点灵力，将对你造成伤害的牌交给一名其他角色并冻结至其回合结束。",
	["nightreturn"] = "永夜返",
	[":nightreturn"] = "你可以支付两点灵力，跳过你的判定阶段、出牌阶段和弃牌阶段。",
	["@fiveproblem"] = "请指定【五道难题】的对象",
	...
	["kamikakushi"] = "八云紫的神隐",
	[":kamikakushi"] = "锁定技，其他玩家到你的距离+1；被束缚的玩家到你的距离额外再加+1。",
	
	["blackbutterfly"] = "二重 黑死蝶",
	[":blackbutterfly"] = "你受到伤害时，可弃掉一张梅花手牌，束缚所有其他玩家直到其摸牌阶段：出牌阶段开始时，对方需弃掉一张梅花牌，否则流失一点体力。",
	["@black-butterfly"] = "请弃掉一张梅花牌，否则流失一点体力",
	...
	["kanako"] = "八坂神奈子",
	["onbashira"] = "四条御柱",
	[":onbashira"] = "出牌阶段每回合一次，你可以弃掉两张手牌，令任意一名角色与你一同回复或失去1点灵力。",
	
	["belief"] = "信仰",
	[":belief"] = "回合结束阶段若你的灵力大于体力，你可以回复一点体力。",
	...
	["marisa"] = "雾雨 魔理沙",
	["masterspark"] = "Master Spark",
	[":masterspark"] = "你可将你的任意黑色牌当做【弹幕】使用或打出。",
	["thiefmarisa"] = "神偷魔理沙！",
	[":thiefmarisa"] = "锁定技，你到其他玩家的距离-1。",
	...
	["ran"] = "八云 蓝",
	["godsbanquet"] = "十二神将之宴",
	[":godsbanquet"] = "摸牌阶段，你可放弃摸牌并从每个被束缚的玩家手牌中抽取一张牌。",
	
	["ninetail"] = "策士之九尾",
	[":ninetail"] = "你的手牌上限+X，X为你的灵力值。出牌阶段，你可以弃一张手牌回复一点灵力。",
	
	["phantasm"] = "仙狐思念",
	[":phantasm"] = "你到被束缚玩家的距离-10。",
	["ultimatebuddhist"] = "最终佛徒",
	[":ultimatebuddhist"] = "回合外你可支付一点灵力，将一张梅花手牌交给濒死玩家令其回复一点体力。",
	
	["satori"] = "古明地 觉",
	["mindreader"] = "读心术",
	[":mindreader"] = "摸牌阶段你可以放弃摸牌，查看一名玩家的手牌并从中选取2张收入手牌。若你如此做，该玩家摸2张牌。",
